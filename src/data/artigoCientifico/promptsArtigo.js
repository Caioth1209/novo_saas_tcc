...
export default [
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em formatação de Artigo Científico. Sua tarefa é escrever detalhadamente a continuação do desenvolvimento que será utilizada para abordar o tema ${tema} e alcançar o objetivo ${objetivo}. A descrição deve abranger as seguintes etapas da pesquisa:
        ...
        PS: Essa é a continuação do desenvolvimento, escreva o restante da parte inicial desenvolvimento que foi solicitada anteriormente.
        `
      },
      hasReferences: true,
      isContinuation: true
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em elaborar revisões de literatura para Artigos Científicos. Sua tarefa é redigir a continuação de uma revisão de literatura detalhada sobre o tema ${tema}. Ao longo da revisão, você deve incluir citações pertinentes retiradas de fontes confiáveis e reais, com prioridade para referências recentes fornecidas no arquivo anexado. As referências bibliográficas devem conter o nome do autor, título do trabalho e o link de acesso.
        ...
        Para a estrutura da revisão de literatura:
          ...
          PS: Essa é a continuação da revisão de literatura, escreva o restante da parte inicial revisão de literatura que foi solicitada anteriormente.
        `
      },
      hasReferences: true,
      isContinuation: true
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
          Você é um redator acadêmico especializado em redação de Artigos Científicos. Sua tarefa é descrever detalhadamente a continuação da metodologia que será utilizada para abordar o tema ${tema} e alcançar o objetivo ${objetivo}. A descrição deve abranger as seguintes etapas da pesquisa:
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em apresentação de resultados de pesquisas para Artigos Científicos. Sua tarefa é apresentar a continuação dos resultados obtidos com base na metodologia aplicada ao tema ${tema}. A apresentação dos resultados deve ser clara e organizada, com uma análise detalhada dos dados coletados.
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em redação de Artigos Científicos. Sua tarefa é elaborar a continuação da discussão sobre os resultados obtidos para o tema ${tema}. A discussão deve:
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em redação de Artigo Científico. Sua tarefa é elaborar a continuação da discussão sobre os resultados obtidos para o tema ${tema}. A discussão deve:
    ...
    },
    {
      ...
      get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
        return `
        Você é um redator acadêmico especializado em elaborar a conclusão para artigos científicos. Sua tarefa é escrever, em português do Brasil, a continuação da conclusão de um Artigo Científico na área de ${areaEstudo}, cujo tema é ${tema}. A conclusão deve:
