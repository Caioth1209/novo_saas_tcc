export default [
    ...
    },
    {
        ...
        get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
            ...
            Lembre-se: é obrigatório fazer pelo menos três citaçoes, contento o nome do autor e o ano do seu trabalho, no decorrer do texto e essas citações devem ser retiradas exclusivamente do arquivo anexado.
    ...
    },
    {
        ...
        get: (tema, areaEstudo, objetivo, perguntaPesquisa) => {
            ...
            Lembre-se: é obrigatório fazer pelo menos 3 citações, contento o nome do autor e o ano do seu trabalho, no decorrer do texto e essas citações devem ser retiradas exclusivamente do arquivo anexado.
    ...
    },
    {
        ...
        get: (tema) => {
            ...
            IMPORTANTE: Separe cada parágrafo do texto com o delimitador [--].
            ...
            Lembre-se: é obrigatório fazer pelo menos 8 (oito) citações, contento o nome do autor e o ano do seu trabalho, no decorrer do texto e essas citações devem ser retiradas exclusivamente do arquivo anexado.
    ...
    },
    {
        ...
        get: (tema) => {
            ...
            IMPORTANTE: Utilize o delimitador [--] para separar cada parágrafo, para facilitar o pós processamento.
    ...
    },
    {
        key: "metodologia",
        get: (tema, x, objetivo) => {
            return `Dando continuidade à seção de metodologia, elabore uma conclusão para esta parte do trabalho, seguindo rigorosamente as diretrizes estabelecidas anteriormente. É fundamental que você respeite todas as regras delineadas na metodologia anterior e as repita aqui. Seu objetivo é fornecer uma conclusão que complemente a metodologia de maneira coesa e lógica.

            A conclusão deve conter no mínimo 8 parágrafos e incluir citações reais extraídas do arquivo anexado. Essas citações devem ser incorporadas de forma a reforçar os argumentos e as decisões metodológicas apresentadas, garantindo a consistência e a profundidade da discussão.

            Certifique-se de manter o mesmo estilo, tom e formatação utilizados na seção de metodologia, assegurando que a conclusão flua naturalmente a partir do conteúdo anterior e resuma de forma clara os principais aspectos da metodologia utilizada, além de destacar a relevância e a eficácia dos métodos empregados na pesquisa.`;
        },
        hasReferences: true,
        isContinuation: true
    },
    {
        key: "resultados",
        get: (tema) => {
            return `Você é um redator acadêmico especializado em apresentação de resultados de pesquisas para Trabalhos de Conclusão de Curso (TCC). Sua tarefa é apresentar os resultados obtidos com base na metodologia aplicada ao tema ${tema}. **Não faça a conclusao dessa seção**, deixe em aberto, a conclusão desta seção será feita em um momento posterior. A apresentação dos resultados deve ser clara e organizada, com uma análise detalhada dos dados coletados.
            ...
            O texto deve conter no mínimo 8 parágrafos, com um total de pelo menos 1000 caracteres.
            IMPORTANTE: Utilize o delimitador [--] para separar cada parágrafo.
    ...
    },
    {
        ...
        get: () => {
            return `
            Dando continuidade à seção de resultados, elabore uma conclusão para esta parte do trabalho, seguindo rigorosamente as diretrizes estabelecidas anteriormente. É fundamental que você respeite todas as regras delineadas na seção de resultados anterior e as repita aqui. Seu objetivo é fornecer uma conclusão que complemente os resultados apresentados de maneira coesa e lógica.

            A conclusão deve conter no mínimo 8 parágrafos e incluir citações reais extraídas do arquivo anexado. Essas citações devem ser utilizadas de forma a reforçar a análise dos resultados, garantindo a consistência e a profundidade da discussão.

            Certifique-se de manter o mesmo estilo, tom e formatação utilizados na seção de resultados, assegurando que a conclusão flua naturalmente a partir do conteúdo anterior e resuma de forma clara os principais achados da pesquisa, além de discutir sua relevância e implicações no contexto do estudo.`
        },
        hasReferences: true,
        isContinuation: true
    },
    {
        key: "discussao",
        get: (tema) => {
            return `Você é um redator acadêmico especializado em redação de Trabalhos de Conclusão de Curso (TCC). Sua tarefa é elaborar a PRIMEIRA PARTE de uma discussão detalhada sobre os resultados obtidos para o tema ${tema}. **Não faça a conclusao dessa seção**, deixe em aberto, a conclusão desta seção será feita em um momento posterior. A discussão deve:
    ...
    },
    {
        ...
        get: () => {
            return `
            Dando continuidade à seção de discussão, elabore uma conclusão para esta parte do trabalho, seguindo rigorosamente as diretrizes estabelecidas anteriormente. É fundamental que você respeite todas as regras delineadas na seção de discussão anterior e as repita aqui. Seu objetivo é fornecer uma conclusão que complemente a discussão apresentada de maneira coesa e lógica.

            A conclusão deve conter no mínimo 8 parágrafos e incluir citações reais extraídas do arquivo anexado. Essas citações devem ser utilizadas de forma a reforçar os argumentos e as interpretações discutidos, garantindo a consistência e a profundidade da análise.

            Certifique-se de manter o mesmo estilo, tom e formatação utilizados na seção de discussão, assegurando que a conclusão flua naturalmente a partir do conteúdo anterior e resuma de forma clara os principais pontos abordados, além de destacar a relevância das descobertas e suas implicações para o campo de estudo.`
        },
        hasReferences: true,
        isContinuation: true
    },
    {
        key: "conclusao",
        get: (tema) => {
            return `Você é um redator acadêmico especializado em redação de Trabalhos de Conclusão de Curso (TCC). Sua tarefa é elaborar uma conclusão para o TCC sobre o tema ${tema}. A conclusão deve:
            ...
            O texto deve conter no mínimo cinco parágrafos, com um total de pelo menos 1500 caracteres.
            Utilize o delimitador [--] para separar cada parágrafo.
